    ...
    <main>
        <section class="main-exchange-container">
            ...
            <div class="main-exchange-container--title">
                ...
                <p>Traemos informacion en tiempo real de las
                    casas de cambio y las monedas mas importantes
                    del mundo.
                </p>
            </div>
            <section class="main-tables-container">
                <div class="main-currency-table">
                    ...
                    <div class="currency-table--container">
                        <table>
                            <tr><!--row-->
                                <td class="table__top-left">Bitcoin</td><!--data-->
                            ...
                            <tr>
                                ...
                                <td class="table__bottom-right
                                table__right">$4.96<span class="down"></span></td>
                            </tr>
                        </table>
                    </div>
        ...
        <section class="main-product-detail">
            ...
            <section class="product-cards--container">
                <article class="product-detail--card">
                    ...
                    <p class="product--card-body">Nuestra API toma informacion
                        minuto a minuto sobre las tasas que mas determinan
                        el comportamiento.
                    </p>
                </article>
            </section>
            <section>
                <article class="product-detail--card">
                    ...
                    <p class="product--card-body">Ni en la compra o al momento
                        de exit, Batabit siempre te muestra el costo real
                        de lo que estas adquiriendo.
                    </p>
                </article>
            </section>
            <section>
                <article class="product-detail--card">
                    ...
                    <p class="product--card-body">No más rumores, con Babtabit
            ...
            <section>
                <article class="product-detail--card">
                    ...
                    <p class="product--card-body">Nuestras fuentes estan 100%
                        verificadas y continuamos auditando su contenido mientras
                        se actualizan.
                    </p>
                </article>
            </section>
